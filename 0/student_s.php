                    ...
                    <div class="col-md-3">
                            ...
                            ?>  <?php
                              if(isset($_SESSION['unique_id'])){
                                ...
                                echo '<a href="user/test/"><button type="button" class="btn btn-outline-light text-uppercase mt-2 w-100">Exam 2</button></a>';
...
<div class="container mt-3 text-center m-auto">
  ...
  <div class="row">
    ...
    // if(isset($_SESSION['role']));
    ?>
      <a href="user/test/"><button type="button" class="btn btn-info w-100">Exam System 2</button></a>
    </div>
    <div class="col-md-3 mt-2 from-floating from-control">
