...
if(isset($_POST['postaa'])){
                                    ...
                                    $pid=$_POST['post_iid'];
                                    $select = "SELECT * FROM comment_box WHERE post_id='$pid' AND parent_id='0' AND mode='p' ORDER BY id DESC";
                                    ...
                                    if($mynum>0){
                                      while($roww=mysqli_fetch_assoc($myselect)){
                                        ...
                                        <hr>
                                          ...
                                          <?php
                                              $comid=$roww['id'];
                                              $reply="SELECT * FROM comment_box WHERE parent_id='$comid' AND post_id='$pid'  AND mode='p'";
...
if(isset($_POST['posta'])){
    ...
    $sql="UPDATE post SET com_count=com_count+1 WHERE id=$postid ";
...
if(isset($_POST['comment_load_data'])){
  ...
  $comments_query = "SELECT * FROM comment_box WHERE parent_id='0' AND post_id='$postid' AND mode='p' order by id DESC";
...
if(isset($_POST['view_comment_data'])){
  ...
  $query = "SELECT * FROM comment_box WHERE parent_id='$commentid' AND mode='p' order by id DESC";
...
if(isset($_POST['reply_add'])){
  ...
  $pselect = "SELECT * FROM comment_box WHERE mode='p' AND id='$parent'";
  ...
  $sql1="UPDATE comment_box SET view_reply=view_reply+1 WHERE id=$parent AND mode='p'";
...
if(isset($_POST['sub_reply_add'])){
  ...
  $pselect = "SELECT * FROM comment_box WHERE id='$po' AND mode='p'";
  $pselect_run = mysqli_query($con, $pselect);
  $pselect_row=mysqli_fetch_assoc($pselect_run);
