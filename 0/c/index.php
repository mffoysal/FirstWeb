                	...
                	<form role="form" id="logform">
                    	<fieldset>
                        	<div class="form-group">
                            	<input class="form-control" placeholder="Phone/Student ID" name="username" id="username" type="phone" autofocus>
                            	<input class="form-control" placeholder="Phone/Student ID" name="melogin" id="melogin" type="hidden">
                        	</div>
            	...
            	<div class="panel-body">
                	<form role="form" id="signform">
                    	<fieldset>
                          ...
                          <div class="form-group">
                            	<input class="form-control" placeholder="Class Code" name="classnumber" id="classNumber" type="number" autofocus>
                        	</div>
                        	<div class="form-group">
                            	<input class="form-control" placeholder="Mentor Id" name="mentorId" id="mentorId" type="text">
                        	</div>
