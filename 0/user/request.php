         ...
         <div style="border: 2px solid black; border-radious:10px" class="col border-dark">
            ...
            if(isset($_SESSION['unique_id'])){
                ...
                //   }
                  ...
                  $queryuser2="SELECT * FROM friends WHERE  status='Pending' AND to_id='$from_id'";
                  ...
                  while($row2 =mysqli_fetch_assoc($queryuresult2)):
                    ...
                    <div class="notifi-item">
                      <?php if($row2['image']!=''){
                        echo '<img style="padding-top:0px" class="d-inline" src="../image/'.$row2['image'].'" alt="img">';
                      }else{
                      ...
                      <?php if($row2['address']==''){
                        $row['address'] ="userDistrict,upazila,union";
                      } ?>
                      ...
                      <input type="hidden" name="updatename" value="<?=$rowf['name']?>">
                      <input type="hidden" name="updateimage" value="<?=$rowf['img']?>">
                      <input type="hidden" name="fromid" value="<?=$from_id?>">
                      <input type="hidden" name="toid" value="<?=$row2['from_id']?>">
                      <input type="hidden" name="updateaddress" value="<?=$rowf['district'].', '.$rowf['upazila'].', '.$rowf['unions']?>">
                    <?php
                      if(isset($_SESSION['unique_id'])){
                       echo '<button type="submit" name="acceptfriend" class="btn btn-outline-primary d-block w-100">Accept</button>';
                      }
                      ?>
