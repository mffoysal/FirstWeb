...
<div class="container text-center w-50">
       ...
       <div class="row">
         ...
         <div style="border: 2px solid black; border-radius:10px" class="col border-dark">
            <div class="row">
              <?php
                ...
                // }
                  ...
                  while($row =mysqli_fetch_assoc($value)):
                    ...
                    <div style="border: 1px solid black; border-radius:10px" class="col-md-6 border-info">
