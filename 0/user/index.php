...
$qq = "SELECT * FROM users WHERE unique_id!='' ";
$record=mysqli_num_rows(mysqli_query($con,$qq));
  ...
  $record=mysqli_num_rows(mysqli_query($con,$qq));
    ...
    $pagi=ceil($record/$per_page);
          ...
          if(!empty($searchkey)){    
              $query = "SELECT * FROM users WHERE name LIKE '%$searchkey%' OR phone LIKE '%$searchkey%' OR email LIKE '%$searchkey%' OR district LIKE '%$searchkey%' OR upazila LIKE '%$searchkey%' OR unions LIKE '%$searchkey%' limit $start, $per_page";
              ...
              // }
              $query = "SELECT * FROM users WHERE unique_id!='' limit $start, $per_page";
              $searchkey = "";
          }
                ...
                // }
                  ...
                  while($row =mysqli_fetch_assoc($value)):
                    ...
                    <div class="notifi-item">
                      ...
                      ?>
                      <input type="hidden" id="tofriend" name="tofriend" value="<?=$row['unique_id']?>">
                      ...
                      if(isset($_SESSION['unique_id'])){
                        ...
                        if($conf>0){
                          ...
                          echo '<button type="submit" name="addfriend" id="insert" onclick="submitform()" class="btn btn-outline-primary d-block w-100">ADD</button>';
                        }
