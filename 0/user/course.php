         ...
         <div style="border: 2px solid black; border-radious:10px" class="col border-danger">
            ...
            if(isset($_SESSION['unique_id'])){
                ...
                $from_id="";
                  ...
                  $queryuser2="SELECT * FROM activated WHERE  status='Confirm' AND std_id='$from_id'";
                  ...
                  while($row2 =mysqli_fetch_assoc($queryuresult2)):
                    ?>
                        <?php
                            $fq="SELECT * FROM users WHERE unique_id='$row2[tutor_id]'";
                    ...
                    <div class="notifi-item">
                      ...
                      <?php if($rowf['unions']==''){
                        ...
                        <span class="text-center text-danger"><a style="text-decoration:none; color;red" class='text-warning' href="user.php?unique_id=<?=$row2['tutor_id']?>">PROFILE <span class="text-uppercase text-danger"><?=$rowf['actype']?></span></a></span>
                      
                      </div>
                      <div class="text text-center m-auto">
                      <a style="text-decoration:none" href="user.php?unique_id=<?=$row2['tutor_id']?>"><button type="button" class="btn btn-outline-info d-block w-100">PROFILE</button></a>
                    <?php
                      if(isset($_SESSION['unique_id'])){
                       echo '<a style="text-decoration:none" href="activated.php?unique_id='.$row2['tutor_id'].'"><button type="submit" name="addfriend" class="btn btn-outline-primary d-block w-100">Go To Course</button></a>';
                      }
                      ?>
