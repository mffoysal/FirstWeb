...
$query = "SELECT * FROM mess_expense WHERE mid='{$the_member}' AND expense_date='{$the_date}' AND mess_id='{$messid}'";
...
<ol class="breadcrumb">
    ...
    <li class="active">
        <i class="fa fa-file"></i> হিসাব পরিবর্তন
    </li>
</ol>
...
<form method="post">
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label">টাকা</label>
    <div class="col-sm-10">
