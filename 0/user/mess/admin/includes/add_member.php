...
if(isset($_POST['submit_reg']) && $_POST['randcheck'] == $_SESSION['rand']){
    ...
    if(!empty($uname) && !empty($uemail) && !empty($upass)){
         $query = "INSERT INTO users(name,phone,pass,mess_id) ";
        $query .="VALUES('{$uname}','{$uemail}','{$upass}','{$messid}' ) ";
					...
					?>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="phone" name="email" id="email" class="form-control" placeholder="015858550...">
                        </div>
                         <div class="form-group">
