...
$qq = "SELECT * FROM users WHERE unique_id!='' AND actype='mentor' ";
$record=mysqli_num_rows(mysqli_query($con,$qq));
  ...
  $record=mysqli_num_rows(mysqli_query($con,$qq));
    ...
    $pagi=ceil($record/$per_page);
          ...
          if(!empty($searchkey)){    
              $query = "SELECT * FROM users WHERE name LIKE '%$searchkey%' AND actype='mentor' OR phone LIKE '%$searchkey%' AND actype='mentor' OR email LIKE '%$searchkey%' AND actype='mentor' OR district LIKE '%$searchkey%' AND actype='mentor' OR upazila LIKE '%$searchkey%' AND actype='mentor' OR unions LIKE '%$searchkey%' AND actype='mentor' limit $start,  $per_page";
              ...
              // }
              $query = "SELECT * FROM users WHERE unique_id!='' AND actype='mentor' limit $start, $per_page";
              $searchkey = "";
          }
...
<div class="container text-center w-50">
       ...
       <div class="row">
         ...
         <div style="border: 2px solid black; border-radius:10px" class="col border-light">
            <div class="row">
              <?php
                //   function users($id,$name,$img,$phone,$dis,$upa,$union,$vil,$status,$point,$education,$ac){
                //     $usersvalue = "
                //     <div style=\"border: 1px solid black; border-radious:10px\" class=\"col-md-6 border-info\">
                //     <div class=\"notifi-item\">
                //       <img style=\"padding-top:0px\" class=\"d-inline\" src=\"../image/$img\" alt=\"img\">
                //       <div class=\"text\">
                //         <h4>$name</h4>
                //         <p>@$dis,$upa,$union,$vil</p>
                //       </div>
                ...
                //     users($row['unique_id'],$row['name'],$row['img'],$row['phone'],$row['district'],$row['upazila'],$row['unions'],$row['village'],$row['status'],$row['referral_point'],$row['education'],$row['actype']);
                // }
                  ...
                  while($row =mysqli_fetch_assoc($value)):
                    ...
                    <?php
                      $tp="SELECT * FROM tutor WHERE unique_id='$row[unique_id]'";
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-scrollable">
                          <div class="modal-content">
                            <div class="modal-header text-center m-auto">
                              <h5 class="modal-title" id="staticBackdropLabel"><?=$row['name']?>'s- TUTOR POST..</h5>
                            ...
                            <div class="modal-body">
                              <div class="container">
                                <div class="row">
                                  <?php
                                    $tpost="SELECT * FROM tutor WHERE unique_id='$row[unique_id]'";
                                  ...
                                  ?>
                                          ...
                                          <div class="col-md-4 mt-2 mb-2">
                                              <div class="card bg-transparent border-info text-white h-100">
                                                  ...
                                                  <a href="../user.php?unique_id=<?=$row['unique_id']?>"><button type="button" class="btn btn-outline-success w-100">TuTor Profile</button></a>
                                                  <?php
                                                  ...
                                                  if(isset($_SESSION['unique_id'])){
                                                    ...
                                                    if($countms>0){
                                                        echo '<button type="submit" name="addmentor" class="btn btn-outline-info w-100" >Pending for You</button>';    
                                                    }else if($countms2>0){
                                                        echo '<a href="activated.php?unique_id='.$rowt['unique_id'].'"><button type="submit" name="addmentor" class="btn btn-outline-info w-100" >Activated</button></a>';
                                                    }else {
