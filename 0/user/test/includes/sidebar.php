<div style="background: linear-gradient(to right, hsl(180, 100%, 50%), hsl(115, 100%, 50%));" class="app-sidebar sidebar-shadow">
    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li>
                    <a href="#" data-toggle="modal" data-target="#addcourseModal" >
