     ...
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            <label>Your Id</label>
            <input type="" name="courseId" id="course_id" class="form-control" value="<?=$_SESSION['unique_id']?>" readonly>
          </div>
        </div>
      </div>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            <label>Your Id</label>
            <!-- <textarea name="examDesc" class="form-control" rows="4" placeholder="Input Exam Description" required=""></textarea> -->
            <input type="text" name="examId" class="form-control" value="<?=$_SESSION['unique_id']?>" readonly>
          </div>
