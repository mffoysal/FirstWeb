...
$qq = "SELECT * FROM student_request_post WHERE unique_id!='' AND status!='Hide' ";
$record=mysqli_num_rows(mysqli_query($con,$qq));
  ...
  $record=mysqli_num_rows(mysqli_query($con,$qq));
    ...
    $pagi=ceil($record/$per_page);
          ...
          if(!empty($searchkey)){    
              $query = "SELECT * FROM student_request_post WHERE class LIKE '%$searchkey%' AND status!='Hide' OR phone LIKE '%$searchkey%' AND status!='Hide' OR sub LIKE '%$searchkey%' AND status!='Hide' OR address LIKE '%$searchkey%' AND status!='Hide' OR unique_id LIKE '%$searchkey%' AND status!='Hide' OR post_id LIKE '%$searchkey%' AND status!='Hide' limit $start, $per_page";
              ...
              // }
              $query = "SELECT * FROM student_request_post WHERE unique_id!='' AND status!='Hide' limit $start, $per_page";
              $searchkey = "";
          }
                        ...
                        ?>
                                            ...
                                            <div class="col-md-6 mt-2 mb-2">
                                              <div class="card bg-transparent border-info text-white h-100">
                                                  ...
                                                  <form action="stdpostaction.php" method="POST" enctype="multipart/form-data">
                                                  ...
                                                  <a href="user.php?unique_id=<?=$row['unique_id']?>"><button type="button" class="btn btn-outline-success w-100">STUDENT</button></a>
                                                  <?php
                                                  if(isset($_SESSION['unique_id'])){
                                                    ...
                                                    $msquery3="SELECT * FROM student_request_post WHERE unique_id!='$_SESSION[unique_id]' AND post_id='$rowt[post_id]' AND status='Confirm'";
                                                    ...
                                                    if($countms>0){
                                                        ...
                                                        echo '<a href="user.php?unique_id='.$rowt['unique_id'].'"><button type="submit" name="addmentor" class="btn btn-outline-info w-100" >Student Confirmed</button></a>';
                                                    }else {
