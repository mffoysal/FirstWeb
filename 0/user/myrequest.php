       ...
       <div class="row">
         <div style="border: 2px solid black; border-radius:10px" class="col-md-2 border">
                ...
                <div class="col mt-2">
                    ...
                    <button type="button" class="btn btn-warning w-100 mt-1" data-bs-toggle="modal" data-bs-target="#createtutorpost" >Create Std Post</button>
         ...
         <div style="border: 2px solid black; border-radius:10px" class="col border-danger">
            ...
            if(isset($_SESSION['unique_id'])){
                ...
                $from_id="";
                  ...
                  $queryuser2="SELECT * FROM student_request_post WHERE  unique_id='$from_id'";
                                            ...
                                            <div class="col-md-6 mt-2 mb-2">
                                              <div class="card bg-transparent border-info text-white h-100">
                                                  ...
                                                  ?>
                                                        ...
                                                        <form action="stdpostaction.php" method="POST"> 
                                                            <input type="hidden" name="postid" value="<?=$rowt['post_id']?>">
                                                  ...
                                                  if(isset($_SESSION['unique_id'])){
                                                    ...
                                                    $msquery3="SELECT * FROM student_request_post WHERE unique_id='$_SESSION[unique_id]' AND post_id='$rowt[post_id]' AND status='Hide'";
