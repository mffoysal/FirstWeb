...
<input type="hidden" value="<?php?>" id="postid">
<input type="hidden" value="<?php?>" id="comid">
<input type="hidden" value="<?php?>" id="toid">
<input type="hidden" value="<?php?>" id="postuId">
...
<div class="container topcontainer">
    <section id="mainHome" class="section msssgu-1">
            ...
            <div style="margin-top:35px" class="container-fluid grid-container mt-3" id="load_videos" >
    ...
    <section id="postUser" class="section msssgu-2">
        ...
        <div class="row text-center">
            <div class="col">
                <button class="badge btn btn-info all_student_btn student_btn_all" id="all_student_btn">ALL STUDENTS</button>
            </div>
            <div class="col">
                <button class="badge btn btn-primary all_class_section_btn section_btn_all">SECTIONS</button>

            </div>
        </div>
        
        <div class="container classroom_student" id="all_students">
        <!-- <p>Students</p> -->
...
<form method="post" id="update_std_form">  
    <div align="center">
                        <input type="submit" name="multiple_update_std" id="multiple_update_std" class="btn btn-info" value="Update" />
                    </div>
                    <br />
<table class="table w-100 m-auto table-light table-hover table-striped table-borderd border-dark all_std_tablee" id="all_student_table">

      <thead class="table-dark">
            <tr>

            <th class=""><input type="checkbox" checked></th>
            <th class="" width="">SN</th>
            <th>ID</th>
            <th>STD.NAME</th>
            <th>CLASS</th>
            <th>SEC</th>
        ...
        <tbody class="table-striped" id="all_student">
    ...
    <tfoot class="table-dark">
        <tr>
        <td align="left"><span class='btn btn-danger'></span>
        </td>
        ...
        <div class="container classroom_section" id="all_class_sections">

        <p>Classes</p>

                 
<div class="container-fluid" id="section_classes">
...
<div id="msgf" class="msgf" type="button" data-bs-toggle="modal" data-bs-target="#contactmsg">
    <div class="menu-main">
...
<input style="width:5px; height:1px"  type="text" value="http://mffoysal.xyz/r.php?p_id=" id="HtmlCode" readonly>
