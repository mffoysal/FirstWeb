...
$immm="SELECT * FROM qute WHERE id=$postId";
...
<input style="width:5px; height:1px"  type="text" value="http://mffoysal.xyz/q.php?p_id=<?=$postId?>&com_id=<?=$commentId?>&to=<?=$toId?>" id="HtmlCode" readonly>
...
<script type="text/javascript" src="asset/custom2.js"></script>
