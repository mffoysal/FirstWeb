...
<?php
    ...
    //        $sql = $connection->query("INSERT INTO $tbl(pro_id, phone, name, district, address, house, cart_item, item,total_item, price_sum, coupon, subtotal, payment_method, payment_number, payment_trx, msg) VALUES('".$product_id."','".$phone."','".$name."','".$district."','".$address."','".$house."','".$cart_item."','".$item."','".$total_item."','".$price_sum."','".$coupon."','".$price_total."','".$payment."','".$payment_number."','".$payment_trx."','".$msg."')") or die($connection->error);
