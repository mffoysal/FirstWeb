...
<table id="resulttbl" class="table w-100 m-auto table-dark table-hover table-striped table-borderd border-danger">
...
?>
        ...
        <td class="text-warning bg-secondary"><?=$countrow?></td>
        ...
        <td><a href="details.php?action_id=<?=$rowre['exmne_id']?>&exam=<?=$rowre['exam_id']?>"><span id="dlt" onclick="dlt()" class="btn btn-primary">AnsSheet</span></a></td>
