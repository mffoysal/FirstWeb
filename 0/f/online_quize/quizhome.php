...
<html>
<head>
  <title>EdULearn~Quiz HOme</title>
...
<!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="../index.php">EdULearn~Quiz</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      <li class="nav-item active">
        <a class="nav-link text-white" href="../index.php">Home। হোম <span class="sr-only">(current)</span></a>
      </li>
      <!-- <li class="nav-item">
...
<!-- ========================================================================================================================== -->
  ...
  <div class="container mt-4 col-md-10 position-relative">
    <h3 style="font-family: 'Catamaran', sans-serif;">Welcome~ <?php echo $_SESSION['username']; ?> , চল শুরু করি</h3>
  
    <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active " data-toggle="tab" href="#menu1">Home/হোম</a>
    </li>
   <!--  <li class="nav-item">
  ...
  <!-- tab content start -->
   ...
   <div class="tab-content">
     ...
     <center><button type="button" class="btn btn-success mt-5" href="#myid" data-toggle="collapse">বিষয় নির্বাচন করুন</button></center>
 ...
 ?>
      ...
      <button type="submit" class="btn btn-success mt-3">শুরু করুন</button>
  </form>
  </div>
</div>
</div>
  ...
  <tbody>
   ...
   ?>
    <tr >
      <th scope="row"><?php echo $prof['student_id']; ?></th>
      <td><?php echo $prof['username']; ?></td>
      <td><?php echo $prof['email']; ?></td>
      <td><img src="img/<?php echo $prof['student_image']; ?>" class="img-fluid" width="35px" height="30px"></td>
    </tr>
