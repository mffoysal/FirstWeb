...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mt-4 mb-4 text-gray-800">আপনার পরীক্ষার সিডিওল~ টাইমটেবল 24 Ours অনুসারে বাংলাদেশ সময় পাওয়া যাবে.</h1>
                    ...
                    <div class="card shadow-lg mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">পরীক্ষার সিডিওল লিস্ট । Exam List</h6>
                            	</div>
                        ...
                        <div class="card-body shadow-lg">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="exam_table" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Exam Name|পরীক্ষার নাম</th>
                                            <th>Duration।সময়কাল</th>
                                            <th>Result Date & Time।ফলাফলের সময়</th>
                                            <th>Status।অবস্থা</th>
                                            <th>Timetable।বিস্তারিত দেখে নিন</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
