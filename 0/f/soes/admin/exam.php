      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group form-floating">
                        ...
                        <input type="text" name="exam_title" id="exam_title" class="form-control" required  data-parsley-trigger="keyup" />
                    ...
                    <div class="form-group">
                        ...
                        <select name="exam_duration" id="exam_duration" class="form-control" required>
                            ...
                            <option value="90">1 Hour & 30 Miute</option>
                            <option value="100">1 Hour & 40 Minute</option>
