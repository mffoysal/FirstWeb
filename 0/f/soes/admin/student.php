        		...
        		<div class="modal-body">
        			<span id="form_message"></span>
		          	<div class="form-group">
		          		...
		          		<input type="text" name="student_name" id="student_name" class="form-control" required  data-parsley-trigger="keyup" />
		          		<!-- data-parsley-pattern="/^[a-zA-Z0-9 \s]+$/" -->
				  	</div>
                    <div class="form-group">
                        <label>Student Address</label>
                        <input type="text" name="student_address" id="student_address" class="form-control" required  data-parsley-trigger="keyup" />
                    </div>
                    <div class="form-group">
