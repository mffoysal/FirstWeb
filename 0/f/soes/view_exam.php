...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mt-4 mb-4 text-gray-800">Exam Schedule Details|পরীক্ষার সিডিওল বিস্তারিত</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">বিষয়সমূহ</h6>
                            	</div>
                            ...
                            ?>
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <th>সময়কাল</th>
                                        <th>মোট প্রশ্ন</th>
                                        <th>Correct Answer Marks।সঠিক</th>
                                        <th>Wrong Answer Marks।ভূল</th>
                                        <th>Status</th>
                                        <th>শুরু করুন।দেখুন</th>               
                                    </tr>
                                    <?php
