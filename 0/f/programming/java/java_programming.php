...
<html>
<head>
	<title>EdULearn~Programme</title>
	<!----css file link-->
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" style="height: 80px;">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">EdULearn~Text</h1>
			</div>
			<div class="collapse navbar-collapse" id="navi">
                 <!------Navigation menus starts---->
				<ul class="nav navbar-nav navbar-right">
					<li> <a href="../../index.php">হোম/HOME</a></li>
					<li> <a href="../../index.php#myservice_section">প্রোগ্রাম/ক্লাস</a></li>
					<li> <a href="../../index.php#work">গ্যালারি/নোটিশ বোর্ড</a></li>
					<li> <a href="../../index.php#our-members">ইন্সট্রাক্টর/মেন্টর</a></li>
					<li> <a href="../../index.php#myfaq">জরুরী নোটিশ</a></li>
					<li> <a href="#">চ্যাট~বট/</a></li>
...
<?php } ?>
	...
	<div id="mainpagecontent" class="shadow">
		...
		<div onclick="showDiv()" class="content">
			<p class="hi">
		...
		<button onclick="showPrev()" class="btn-info prev" id="">Prev</button>
		<button onclick="showNext()" class="btn-danger next" id="">Next</button>
	
	</div>
	<script type="text/javascript">
		$(document).ready(function(){
			$('.next').click(function(){
				$('.content').find('.hi').next().
				addClass('active');
				$('.content').find('.hi').prev().
				removeClass('active');
			})
		})
	</script>
