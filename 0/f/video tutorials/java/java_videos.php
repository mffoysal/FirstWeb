...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
  <a class="navbar-brand text-white" href="#">EdULearn~videos</a>
...
<br>
<div class="container-fluid" style="overflow: bottom; background-color:yellow">
	<div class="row">
 <section class="col-md-7 mt-4" >
		
		
		<iframe style="border:1px #999 solid;" width="100%" height="450px" 
<?php  
...
<br><br>
		...
		<div class='commentdiv shadow bg-light' style="border:1px #d2c8c8 solid; background-color: #dfe1e4; margin-bottom:20px; ">
<?php  
...
getComments($con);
 ...
 ?>
  ...
  <table class="table table-hover mt-3 table-borderless bg-light">
    <tbody>
	<div class="card-header text-center bg-light"><h5>অন্যন্য ভিডিও~</h5></div>
