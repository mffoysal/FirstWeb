        ...
        <div class="modal-dialog modal-fullscreen" role="document">
            <div class="modal-content  modal-fullscreen">
                <div class="modal-header">
                    ...
                    <h6 class="text-center d-inline" id="total2" >#<span class="bi bi-phone"></span> <?php echo number_format($total + $total*0.017, 2).'৳';?> ড্যালিভারি চার্জ সহ(বিকাশ / নগদ পেমেন্ট) | </h6>
                    <h6 class="text-center d-inline" id="total3" ># <span class="bi bi-cash"></span> <?php echo number_format($total + 30, 2).'৳';?> ড্যালিভারি চার্জ সহ(ক্যাশ অন ডেলিভারি)</h6>
                    <span class='btn btn-warning text-dark'>মোটঃ <?php echo number_format($total + 50, 2).'৳ out of 10 km';?></span>|<a href="index.php?action=clearall"><button type="button" class="btn btn-danger"><span class="bi bi-trash"></span></button></a>|
                    </div>
                    <!-- <h6 class="text-center" id="total" ><?php echo number_format($total + 50, 2).'৳';?></h6> -->
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                        ...
                        <div class="container bg-light">
                            ...
                            <div class="col-md-4 form-floating">
                                  ...
                                  <label for="tel"><span class="bi bi-phone"></span> Valid Phone Number: <span class="text-muted">[OPTIONAL]</span></label>
                                  ...
                                  <div class="form-floating">
                                  <input class="form-control text-center" id="email" type="email" name="email" placeholder="Enter Your Email">
                                ...
                                <div class="col-md-4 form-floating">
                                  ...
                                  <button type="button" id="iddd" class="hi btn btn-dark" onclick="apply()">APPLY</button>
                                  ...
                                  <input type="text" class="btn btn-light" id="total" readonly>
                                  ...
                                  <div class="accordion accordion-flush" id="accordionFlushExample">
                                    <div class="accordion-item">
                                        ...
                                        <button style="color: red" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                            Cash On Delivery #1 <span>.....</span>   <h6 class="text-center" id="total3" >    <?php echo number_format($total + 30, 2).'৳';?></h6>
                                        </button>
                                        </h2>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">সম্মানিত ভাই ও বোন, আপনি যদি ক্যাশ অন ডেলিভারি অর্থাৎ হাতে হাতে টাকা দিতে চান তাহলে সবচেয়ে নিরাপদ... <code>.প্রিয় ভাই - বোন , আপনার অবস্থান অনুসারে আপনাকে ডেলিভারি চার্জ দিতে হবে , তাই আপনি ০১৫৮৫৮৫৫০৭৫ এই নম্বরে ফোন করে জেনে নিন</code> 
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <button style="color: red" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                                            Bkash #2 <span>......</span><h6 class="text-center" id="total2" ><?php echo number_format($total + $total*0.017, 2).'৳';?></h6>
                                        </button>
                                        </h2>
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body"><code>.প্রিয় ভাই - বোন , আপনার অবস্থান অনুসারে আপনাকে ডেলিভারি চার্জ দিতে হবে , তাই আপনি ০১৫৮৫৮৫৫০৭৫ এই নম্বরে ফোন করে জেনে নিন, তারপর পেমেন্ট করুন</code> 
                                                Dear Brothers & Sisters,...... সম্মানিত ভাই ও বোন, বিকাশ অথবা নগদ এ পেমেন্ট করতে নিচের তথ্য পূরণ করুন।। <br>
                                                <code><h6 class="text-center" id="total2" >আপনি পেমেন্ট করবেনঃ <?php echo number_format($total + $total*0.017, 2).'৳';?> টাকা</h6></code>
                                                
                                                <code>Bkash Personal: 01585855075</code>
                                                <br>
                                                <code>Bkash/Nogod Charge: 0.02%</code> 
                                        <div class="form-floating">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <button style="color: red" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                                            Nagad #3 <span>......</span><h6 class="text-center" id="total2" ><?php echo number_format($total + $total*0.017, 2).'৳';?></h6>
                                        </button>
                                        </h2>
                                        ...
                                        <div class="accordion-body"><code>.প্রিয় ভাই - বোন , আপনার অবস্থান অনুসারে আপনাকে ডেলিভারি চার্জ দিতে হবে , তাই আপনি ০১৫৮৫৮৫৫০৭৫ এই নম্বরে ফোন করে জেনে নিন, তারপর পেমেন্ট করুন</code> 
                                                ...
                                                <code>Nagad Personal: 01585855075</code>
                                                <br>
                                                <code>Bkash/Nogod Charge: 0.02%</code> 
                                        <div class="form-floating">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-body"><code>.প্রিয় ভাই - বোন , আপনার অবস্থান অনুসারে আপনাকে ডেলিভারি চার্জ দিতে হবে , তাই আপনি ০১৫৮৫৮৫৫০৭৫ এই নম্বরে ফোন করে জেনে নিন, তারপর পেমেন্ট করুন</code> 
                                                Dear Brothers & Sisters,...... সম্মানিত ভাই ও বোন, বিকাশ অথবা নগদ এ পেমেন্ট করতে নিচের তথ্য পূরণ করুন।। <br>
                                                <code><h6 class="text-center" id="total2" >আপনি পেমেন্ট করবেনঃ <?php echo number_format($total + $total*0.02, 2).'৳';?> টাকা</h6></code>
                                                
                                                <code>Islami Bank AC: 01585855075</code>
                                                <br>
                                                <code>DBBL AC: 01585855075</code>
                                                <br>
                                                <code>Bkash/Nogod Charge: 0.02%</code> 
                                        <div class="form-floating">
                                                <input class="form-control text-center" id="bkash" type="text" name="payment_number" placeholder="Enter Your " value="<?php ?>">
                ...
                <?php  if(isset($_GET['action'])){
                        ...
                        |<span class='btn btn-primary'><?php echo number_format($qntotal).'টি';?></span>
                    <a href="index.php?action=clearall"><button type="button" class="btn btn-danger"><span class="bi bi-trash"></span>|</button></a>        
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                    <!-- <input type="submit" class="btn btn-primary" value="Submit"> -->
                    <a href="index.php?action=clearall"><button type="submit" class="btn btn-primary" name="save" data-bs-toggle="modal" data-bs-target="#" ><span class="bi bi-cart-check"></span> Order</button></a>
                </div>
